...
if __name__=="__main__":
	fa = FrankArm()
	# fa.PlotCollisionBlockPoints([0,0,0,0,0,0,0])
	...
	ref_ori,ref_rot, ref_dim = [[0, 0, 0], [0, 0, 0], [3, 1, 2]]
	ref_H = rt.rpyxyz2H(ref_rot, ref_ori)
	ref_points, ref_axes = rt.BlockDesc2Points(ref_H, ref_dim)

	for test in test_case:
		ori = test[0]
		rot = test[1]
		dim = test[2]
		H = rt.rpyxyz2H(rot, ori)
		points, axes = rt.BlockDesc2Points(H, dim)
		# print(axes)
		bool_1 = rt.CheckBoxBoxCollision(ref_points, ref_axes, points, axes)
		result.append(bool_1)
	print("final", result)
	...
	True
	True
	final [False, False, True, True, True, False, True, True]
