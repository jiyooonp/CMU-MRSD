...
class DetectorBackboneWithFPN(nn.Module):
    ...
    def __init__(self, out_channels: int):
        ...
        self.lateral1 = nn.Conv2d(dummy_out_shapes[0][1][1], out_channels, 1, stride=1, padding = 0 )
        self.lateral2 = nn.Conv2d(dummy_out_shapes[1][1][1], out_channels, 1, stride=1, padding = 0 )
        self.lateral3 = nn.Conv2d(dummy_out_shapes[2][1][1], out_channels, 1, stride=1, padding = 0 )

        self.output1 = nn.Conv2d(out_channels, out_channels, 3, stride=1, padding=1)
        self.output2 = nn.Conv2d(out_channels, out_channels, 3, stride=1, padding=1)
        self.output3 = nn.Conv2d(out_channels, out_channels, 3, stride=1, padding=1)
        ######################################################################
        #                            END OF YOUR CODE                        #
        ######################################################################
