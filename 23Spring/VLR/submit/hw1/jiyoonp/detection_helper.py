...
def train_detector(
    ...
    torch.save(detector.state_dict(), "../saves/fcos_detector.pt")
...
def inference_with_detector(
    ...
    all_images = []
    print("testing on:", len(test_loader))
    for iter_num, test_batch in enumerate(test_loader):
        ...
        with torch.no_grad():
            if score_thresh is not None and nms_thresh is not None:
                ...
                # print("pred_boxes, pred_classes, pred_scores", pred_boxes, pred_classes, pred_scores)
